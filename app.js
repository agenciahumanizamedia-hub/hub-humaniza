...
Object.assign(window,{openClientModal,openProjectModal,closeModals,saveClient,saveProject,selectClient,selectProject,deleteClient,copyClientLink,approveStrategic,approveProduction,approveCalendar,requestAdjust,autoGrow,render,addContentItem,removeContentItem,toggleChecklist,formatText,formatHighlight,clearFormat,releaseStage});
...
function richField(label,id,value){
  return `<div class="content-box rich-box">
    ...
    <div class="rich-toolbar">
      <button type="button" onclick="formatText('bold')" title="Negrito">B</button>
      <button type="button" onclick="formatText('foreColor','#5B56FF')" title="Letra roxa">Roxo</button>
      <button type="button" onclick="formatText('foreColor','#1C1C1C')" title="Letra preta">Preto</button>
      <button type="button" onclick="formatText('foreColor','#FFFFFF')" title="Letra branca">Branco</button>
      <button type="button" onclick="formatHighlight()" title="Fundo preto com letra branca">Destaque</button>
      <button type="button" onclick="clearFormat()" title="Remover formatação">Limpar</button>
    </div>
